...
const About = () => {
  return (
    <section className="max-container bg-[#f9f9f9] font-sans">
      {/* <h2 className="head-text text-center text-[#2d6a4f] mb-5">About Us</h2> */}
      <div className="text-center">
        <h1
          className="head-text inline-block lg:text-4xl text-center text-[#2d6a4f] mb-7 mt-0 font-semibold bg-gradient-to-r from-blue-500 to-teal-500 bg-clip-text text-transparent"
      ...
      <div className="flex flex-col xl:flex-row gap-0 lg:gap-5">
        {/* About us Image */}
        <div className="flex w-full xl:w-[40%] h-[390px] xl:h-auto lg:rounded-lg p-4 bg-white z-10 overflow-hidden lg:shadow-lg">
          <img
            src={about_cover}
