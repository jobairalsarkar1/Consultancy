...
const Hero = () => {
  ...
  return (
    <section className="relative bg-cover bg-center h-screen flex items-center justify-center">
      <div className="px-5 sm:px-24 h-full text-center grid grid-cols-1 lg:grid-cols-2">
        {/* Text and Button Holder */}
        <div className="px-4 flex flex-col items-center justify-center z-20">
          <img
            src={plane}
          ...
          <p className="text-lg md:text-xl mb-8 font-sans">
            <strong>Care2 Training Consultancy </strong>offers personalized
            support to help you study, work, or live abroad with confidence and
            ease.
          </p>
          <Link
            to="contact"
            smooth={true}
            duration={500}
            className="bg-gradient-to-r from-blue-500 to-teal-500 text-white hover:from-teal-500 hover:to-blue-500 font-semibold py-3 px-8 rounded-xl text-lg transition-all cursor-pointer"
